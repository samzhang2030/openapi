...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'deepseek' | 'mixed'
...
const BADGE: Record<Platform, string> = {
  ...
  mixed: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30 dark:text-cyan-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  mixed: 'bg-cyan-500/10 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  mixed: 'border-cyan-500/20 dark:border-cyan-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  mixed: 'bg-gradient-to-r from-cyan-400 to-teal-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  mixed: 'text-cyan-700 dark:text-cyan-300',
}
...
const ICON: Record<Platform, string> = {
  ...
  mixed: 'text-cyan-500 dark:text-cyan-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  mixed: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  mixed: 'from-cyan-500 to-teal-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'deepseek' || p === 'mixed'
}
