export default {
  ...
  rechargeCenter: {
    title: '充值中心',
    subtitle: '先选择最合适的充值入口，再进入对应流程。把入口收拢以后，用户不需要再自己分辨外部商城、兑换页和后续到账步骤。',
    back: '返回',
    unknownUser: '当前用户',
    balanceLabel: '当前余额',
    statusLabel: '当前通道',
    contactLabel: '联系信息',
    statusEnabled: '站内直充已启用',
    statusFallback: '外部商城 + 站内兑换',
    helperEnabled: '如果你想走官方面板内流程，就用余额直充；如果你已经买好了充值码，可以直接进入兑换页完成到账。',
    helperFallback: '当前充值链路以外部商城为主，购买完成后再回到站内兑换。这样可以先保证支付稳定，再逐步补齐站内支付能力。',
    summaryTitle: '使用方式',
    summaryOneTitle: '先选入口',
    summaryOneDesc: '根据你当前手上的信息决定是先去商城下单，还是直接进入站内兑换动作。',
    summaryTwoTitleEnabled: '完成支付',
    summaryTwoDescEnabled: '在支持的支付通道里完成付款后，再回到面板确认到账结果。',
    summaryTwoTitleFallback: '购买或兑换',
    summaryTwoDescFallback: '先在商城购买充值码，再回 Bridgemind 的兑换页输入卡密，把余额充进去。',
    summaryThreeTitle: '查看结果',
    summaryThreeDesc: '支付或兑换完成后，可以回订单页核对，也可以直接返回面板继续使用 API Key。',
    shop: {
      badge: '主入口',
      title: '充值商城',
      description: '打开外部商城完成充值商品或订阅类商品购买，先确保付款流程稳定顺畅。',
      cta: '打开外部商城',
    },
    direct: {
      badge: '快捷通道',
      title: '余额直充',
      description: '进入 Bridgemind 站内支付流程，直接完成余额充值。',
      cta: '打开直充流程',
    },
    redeem: {
      badge: '已购可用',
      title: '兑换充值码',
      description: '如果你已经买好了充值码，就直接进入兑换页，不用再重复走购买流程。',
      cta: '前往兑换页',
    },
    quickTitle: '快捷入口',
    quickOrders: '查看订单',
    ...
    quickDocs: '打开文档',
    tipTitle: '当前说明',
    tipEnabled: '如果直充付款窗口被中断，可以从支付流程里重新打开；如果你走的是外部购买，先兑换再核对余额会更稳妥。',
    tipFallback: '由于当前站内支付 provider 还没有启用，推荐路径是：先去商城购买，再回 Bridgemind 兑换到账。',
  },
