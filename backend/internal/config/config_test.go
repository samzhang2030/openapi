...
func TestLoad_BindsUpdateExternalUpdaterEnv(t *testing.T) {
	resetViperWithJWTSecret(t)
	t.Setenv("UPDATE_EXTERNAL_UPDATER_COMMAND", "/home/ubuntu/bridgemind/deploy/ops/update_production.sh")
	t.Setenv("UPDATE_EXTERNAL_UPDATER_WORKING_DIRECTORY", "/home/ubuntu/bridgemind")
	t.Setenv("UPDATE_EXTERNAL_UPDATER_HELPER_TIMEOUT_SECONDS", "1800")

	cfg, err := Load()
	require.NoError(t, err)
	require.Equal(t, "/home/ubuntu/bridgemind/deploy/ops/update_production.sh", cfg.Update.ExternalUpdaterCommand)
	require.Equal(t, "/home/ubuntu/bridgemind", cfg.Update.ExternalUpdaterWorkingDirectory)
	require.Equal(t, 1800, cfg.Update.ExternalUpdaterHelperTimeoutSeconds)
}
